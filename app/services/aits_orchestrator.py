        ...
        for record in list(state["decisions"].values()):
            ...
            for checkpoint_name, checkpoint in list((record.get("checkpoints") or {}).items()):
                ...
                dataset = {
                    ...
                    "decision_task": record.get("decision_task") or record.get("task"),
                    "decision_scope": record.get("decision_scope") or record.get("scope"),
                    "provider_source": record.get("provider_source") or record.get("final_provider_source"),
                    "teacher_source": record.get("teacher_source"),
                    "decision_contract_schema": record.get("decision_contract_schema"),
                    "payload_snapshot_schema": record.get("payload_snapshot_schema"),
                    "payload_quality": record.get("payload_quality"),
                    "required_fields_present": record.get("required_fields_present"),
                    "evidence_summary": record.get("evidence_summary"),
                    "task_specific_required_fields": record.get("task_specific_required_fields"),
                    "missing_fields": record.get("missing_fields"),
                    "training_eligibility_precheck": record.get("training_eligibility_precheck"),
                    "feature_context": record.get("feature_context"),
                    ...
                    "local_engine_candidate_observation_schema": record.get("local_engine_candidate_observation_schema"),
                    "local_engine_candidate_observation_status": record.get("local_engine_candidate_observation_status"),
                    "local_engine_candidate_observation_blocker": record.get("local_engine_candidate_observation_blocker"),
                    "local_engine_observation_status": record.get("local_engine_observation_status"),
                    "local_engine_observation_blocker": record.get("local_engine_observation_blocker"),
                    "local_engine_observation_error": record.get("local_engine_observation_error"),
                    "local_engine_candidate_schema": record.get("local_engine_candidate_schema"),
                    "local_engine_candidate_writer_contract": record.get("local_engine_candidate_writer_contract"),
                    "local_engine_candidate_writer_attempted": bool(record.get("local_engine_candidate_writer_attempted")),
                    "local_engine_candidate_writer_success": bool(record.get("local_engine_candidate_writer_success")),
                    "local_engine_validator_metadata": record.get("local_engine_validator_metadata") or {},
                    "local_engine_prediction_id": record.get("local_engine_prediction_id"),
                    "local_engine_candidate_observation_ids": record.get("local_engine_candidate_observation_ids") or [],
                    "local_engine_outcome_linkage_key": record.get("local_engine_outcome_linkage_key"),
                    "local_engine_candidate_only": bool(record.get("local_engine_candidate_only")),
                    "local_engine_applied_to_final_action": bool(record.get("local_engine_applied_to_final_action")),
                    "local_engine_final_action_unchanged": bool(record.get("local_engine_final_action_unchanged")),
